...
def train_model(train_dataset, train_num_each, val_dataset, val_num_each):
    ...
    if not load_exist_LFB:
        ...
        model_LFB.load_state_dict(torch.load("/export/fs06/ahallur1/cholec80/Trans-SVNet_CRF35/best_model/emd_lr5e-4/resnetfc_ce_epoch_19_length_1_opt_0_mulopt_1_flip_1_crop_1_batch_100_train_9957_val_8237_test_7831.pth"), strict=False)
        ...
        #'''
        with open("./LFB/g_LFB50_train.pkl", 'wb') as f:
            pickle.dump(g_LFB_train, f)

        with open("./LFB/g_LFB50_val.pkl", 'wb') as f:
            pickle.dump(g_LFB_val, f)
            
        with open("./LFB/g_LFB50_test.pkl", 'wb') as f:
