...
def train_model(train_dataset, train_num_each, val_dataset, val_num_each):
    ...
    if not load_exist_LFB:
        ...
        model_LFB.load_state_dict(torch.load("/export/fs06/ahallur1/cholec80/Trans-SVNet_CRF23/best_model/emd_lr5e-4/resnetfc_ce_epoch_16_length_1_opt_0_mulopt_1_flip_1_crop_1_batch_100_train_9943_val_8383_test_7988.pth"), strict=False)
